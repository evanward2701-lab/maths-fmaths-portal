...
% Purpose: Flow logic example with capacities and circled current flows.
...
\node[font=\large\bfseries,anchor=west] at (-.5,6.4) {Flow logic example with capacities and circled current flows};
