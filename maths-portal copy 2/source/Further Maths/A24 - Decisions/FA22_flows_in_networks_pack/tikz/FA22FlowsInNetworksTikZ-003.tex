...
% Purpose: Labelling procedure with an augmenting route.
...
\node[font=\large\bfseries,anchor=west] at (-.5,6.4) {Labelling procedure with an augmenting route};
