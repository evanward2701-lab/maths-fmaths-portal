% Asset ID: AS2ForcesAndNewtonsLawsTikZ-012
% Source: Chapter 10 Forces and Motion evidence; CCEA AS2-FORCES boundary
% Related section: Light inextensible string assumptions
...
\node[font=\bfseries\Large] at (0,3.2) {Light inextensible string assumptions};
...
\node[align=center] at (0,-2.0) {Asset AS2ForcesAndNewtonsLawsTikZ-012: Light inextensible string assumptions.};
\end{tikzpicture}
\end{document}
