% Asset ID: AS2ForcesAndNewtonsLawsTikZ-009
% Source: Chapter 10 Forces and Motion evidence; CCEA AS2-FORCES boundary
% Related section: Lift force diagrams
% Purpose: Lift force diagrams.
...
\node[font=\bfseries\Large] at (0,3.2) {Lift force diagrams};
...
\node[align=center] at (0,-2.0) {Asset AS2ForcesAndNewtonsLawsTikZ-009: Lift force diagrams.};
\end{tikzpicture}
\end{document}
