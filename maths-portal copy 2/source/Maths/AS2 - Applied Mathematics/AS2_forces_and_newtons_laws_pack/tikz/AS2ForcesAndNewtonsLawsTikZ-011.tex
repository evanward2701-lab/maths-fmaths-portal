% Asset ID: AS2ForcesAndNewtonsLawsTikZ-011
% Source: Chapter 10 Forces and Motion evidence; CCEA AS2-FORCES boundary
% Related section: Pulley on table with horizontal and vertical string
% Purpose: Pulley on table with horizontal and vertical string.
...
\node[font=\bfseries\Large] at (0,3.2) {Pulley on table with horizontal and vertical string};
...
\node[align=center] at (0,-2.0) {Asset AS2ForcesAndNewtonsLawsTikZ-011: Pulley on table with horizontal and vertical string.};
\end{tikzpicture}
\end{document}
