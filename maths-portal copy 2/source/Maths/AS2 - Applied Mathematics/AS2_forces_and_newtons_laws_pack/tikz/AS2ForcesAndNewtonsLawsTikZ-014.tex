% Asset ID: AS2ForcesAndNewtonsLawsTikZ-014
% Source: Chapter 10 Forces and Motion evidence; CCEA AS2-FORCES boundary
% Related section: Direction of motion and acceleration in lift problems
% Purpose: Direction of motion and acceleration in lift problems.
...
\node[font=\bfseries\Large] at (0,3.2) {Direction of motion and acceleration in lift problems};
...
\node[align=center] at (0,-2.0) {Asset AS2ForcesAndNewtonsLawsTikZ-014: Direction of motion and acceleration in lift problems.};
\end{tikzpicture}
\end{document}
