% Asset ID: AS2ForcesAndNewtonsLawsTikZ-013
% Source: Chapter 10 Forces and Motion evidence; CCEA AS2-FORCES boundary
% Related section: Scale pan and contact forces
% Purpose: Scale pan and contact forces.
...
\node[font=\bfseries\Large] at (0,3.2) {Scale pan and contact forces};
...
\node[align=center] at (0,-2.0) {Asset AS2ForcesAndNewtonsLawsTikZ-013: Scale pan and contact forces.};
\end{tikzpicture}
\end{document}
