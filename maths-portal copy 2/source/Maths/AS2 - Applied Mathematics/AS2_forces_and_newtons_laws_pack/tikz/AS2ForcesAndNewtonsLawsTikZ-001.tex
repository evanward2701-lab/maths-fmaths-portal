% Asset ID: AS2ForcesAndNewtonsLawsTikZ-001
% Source: Chapter 10 Forces and Motion evidence; CCEA AS2-FORCES boundary
% Related section: Free-body diagram for a block on a rough horizontal surface
% Purpose: Free-body diagram for a block on a rough horizontal surface.
...
\node[font=\bfseries\Large] at (0,3.2) {Free-body diagram for a block on a rough horizontal surface};
...
\node[align=center] at (0,-2.0) {Asset AS2ForcesAndNewtonsLawsTikZ-001: Free-body diagram for a block on a rough horizontal surface.};
\end{tikzpicture}
\end{document}
