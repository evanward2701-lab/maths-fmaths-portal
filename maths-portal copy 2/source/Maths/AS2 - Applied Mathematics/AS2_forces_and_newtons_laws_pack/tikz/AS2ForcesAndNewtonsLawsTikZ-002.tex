% Asset ID: AS2ForcesAndNewtonsLawsTikZ-002
% Source: Chapter 10 Forces and Motion evidence; CCEA AS2-FORCES boundary
% Related section: Resolving forces to find the resultant
% Purpose: Resolving forces to find the resultant.
...
\node[font=\bfseries\Large] at (0,3.2) {Resolving forces to find the resultant};
...
\node[align=center] at (0,-2.0) {Asset AS2ForcesAndNewtonsLawsTikZ-002: Resolving forces to find the resultant.};
\end{tikzpicture}
\end{document}
