% Asset ID: AS2ForcesAndNewtonsLawsTikZ-004
% Source: Chapter 10 Forces and Motion evidence; CCEA AS2-FORCES boundary
% Related section: Newton second law with resultant force
% Purpose: Newton second law with resultant force.
...
\node[font=\bfseries\Large] at (0,3.2) {Newton second law with resultant force};
...
\node[align=center] at (0,-2.0) {Asset AS2ForcesAndNewtonsLawsTikZ-004: Newton second law with resultant force.};
\end{tikzpicture}
\end{document}
