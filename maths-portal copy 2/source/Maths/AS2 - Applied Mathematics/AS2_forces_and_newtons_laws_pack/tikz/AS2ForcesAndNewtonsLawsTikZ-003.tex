% Asset ID: AS2ForcesAndNewtonsLawsTikZ-003
% Source: Chapter 10 Forces and Motion evidence; CCEA AS2-FORCES boundary
% Related section: Adding vector forces and finding magnitude and bearing
% Purpose: Adding vector forces and finding magnitude and bearing.
...
\node[font=\bfseries\Large] at (0,3.2) {Adding vector forces and finding magnitude and bearing};
...
\node[align=center] at (0,-2.0) {Asset AS2ForcesAndNewtonsLawsTikZ-003: Adding vector forces and finding magnitude and bearing.};
\end{tikzpicture}
\end{document}
