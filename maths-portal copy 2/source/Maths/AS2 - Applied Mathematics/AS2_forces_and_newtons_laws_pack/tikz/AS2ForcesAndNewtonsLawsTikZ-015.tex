% Asset ID: AS2ForcesAndNewtonsLawsTikZ-015
% Source: Chapter 10 Forces and Motion evidence; CCEA AS2-FORCES boundary
% Related section: Pulley equations for unknown mass ratio
% Purpose: Pulley equations for unknown mass ratio.
...
\node[font=\bfseries\Large] at (0,3.2) {Pulley equations for unknown mass ratio};
...
\node[align=center] at (0,-2.0) {Asset AS2ForcesAndNewtonsLawsTikZ-015: Pulley equations for unknown mass ratio.};
\end{tikzpicture}
\end{document}
