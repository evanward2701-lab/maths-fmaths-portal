% Asset ID: AS2ForcesAndNewtonsLawsTikZ-016
% Source: Chapter 10 Forces and Motion evidence; CCEA AS2-FORCES boundary
% Related section: Two-stage pulley-on-table motion
% Purpose: Two-stage pulley-on-table motion.
...
\node[font=\bfseries\Large] at (0,3.2) {Two-stage pulley-on-table motion};
...
\node[align=center] at (0,-2.0) {Asset AS2ForcesAndNewtonsLawsTikZ-016: Two-stage pulley-on-table motion.};
\end{tikzpicture}
\end{document}
