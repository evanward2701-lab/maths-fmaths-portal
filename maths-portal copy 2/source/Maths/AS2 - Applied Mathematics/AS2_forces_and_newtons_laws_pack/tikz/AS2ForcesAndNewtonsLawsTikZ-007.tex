% Asset ID: AS2ForcesAndNewtonsLawsTikZ-007
% Source: Chapter 10 Forces and Motion evidence; CCEA AS2-FORCES boundary
% Related section: Connected particles as one system
% Purpose: Connected particles as one system.
...
\node[font=\bfseries\Large] at (0,3.2) {Connected particles as one system};
...
\node[align=center] at (0,-2.0) {Asset AS2ForcesAndNewtonsLawsTikZ-007: Connected particles as one system.};
\end{tikzpicture}
\end{document}
