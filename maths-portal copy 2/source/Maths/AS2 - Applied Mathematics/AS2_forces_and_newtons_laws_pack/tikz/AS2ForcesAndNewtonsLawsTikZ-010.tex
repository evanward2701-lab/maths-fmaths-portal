% Asset ID: AS2ForcesAndNewtonsLawsTikZ-010
% Source: Chapter 10 Forces and Motion evidence; CCEA AS2-FORCES boundary
% Related section: Two masses over a smooth pulley
% Purpose: Two masses over a smooth pulley.
...
\node[font=\bfseries\Large] at (0,3.2) {Two masses over a smooth pulley};
...
\node[align=center] at (0,-2.0) {Asset AS2ForcesAndNewtonsLawsTikZ-010: Two masses over a smooth pulley.};
\end{tikzpicture}
\end{document}
