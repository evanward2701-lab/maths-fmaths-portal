% Asset ID: AS2ForcesAndNewtonsLawsTikZ-008
% Source: Chapter 10 Forces and Motion evidence; CCEA AS2-FORCES boundary
% Related section: Newton third law forces act on different bodies
% Purpose: Newton third law forces act on different bodies.
...
\node[font=\bfseries\Large] at (0,3.2) {Newton third law forces act on different bodies};
...
\node[align=center] at (0,-2.0) {Asset AS2ForcesAndNewtonsLawsTikZ-008: Newton third law forces act on different bodies.};
\end{tikzpicture}
\end{document}
