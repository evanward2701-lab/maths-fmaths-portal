% Asset ID: AS2ForcesAndNewtonsLawsTikZ-005
% Source: Chapter 10 Forces and Motion evidence; CCEA AS2-FORCES boundary
% Related section: Bridge from F equals ma to SUVAT
% Purpose: Bridge from F equals ma to SUVAT.
...
\node[font=\bfseries\Large] at (0,3.2) {Bridge from F equals ma to SUVAT};
...
\node[align=center] at (0,-2.0) {Asset AS2ForcesAndNewtonsLawsTikZ-005: Bridge from F equals ma to SUVAT.};
\end{tikzpicture}
\end{document}
