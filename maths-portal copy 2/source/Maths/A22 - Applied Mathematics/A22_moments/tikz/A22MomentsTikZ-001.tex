% Asset ID: A22MomentsTikZ-001
% Source: MechYr2 Chapter 4 Moments, page 2; Rigid Bodies transcript section 1.
% Related lesson section: Big Picture Explanation; Core Theory 1.
% Purpose: Door-handle moment intuition.

\begin{tikzpicture}[scale=0.95, every node/.style={font=\sffamily}]
  \node[draw, rounded corners, fill=blue!8, align=center, minimum width=9cm, minimum height=1cm] at (4,4) {Door-handle moment intuition};
