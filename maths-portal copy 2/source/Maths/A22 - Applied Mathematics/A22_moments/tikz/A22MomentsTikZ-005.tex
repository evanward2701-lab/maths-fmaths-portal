% Asset ID: A22MomentsTikZ-005
% Source: MechYr2 Chapter 4 Moments, pages 12 to 14; Rigid Bodies transcript sections 2 and 3.
% Related lesson section: Worked Example 4; Worked Example 6.
% Purpose: Uniform rod on supports.

\begin{tikzpicture}[scale=0.95, every node/.style={font=\sffamily}]
  \node[draw, rounded corners, fill=blue!8, align=center, minimum width=9cm, minimum height=1cm] at (4,4) {Uniform rod on supports};
