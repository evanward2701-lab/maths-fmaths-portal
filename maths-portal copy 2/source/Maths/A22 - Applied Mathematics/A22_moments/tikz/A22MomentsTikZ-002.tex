% Asset ID: A22MomentsTikZ-002
% Source: MechYr2 Chapter 4 Moments, pages 4 to 6; Rigid Bodies transcript section 1.
% Related lesson section: Key Definitions and Notation; Core Theory 1.
% Purpose: Moment method flow.

\begin{tikzpicture}[scale=0.95, every node/.style={font=\sffamily}]
  \node[draw, rounded corners, fill=blue!8, align=center, minimum width=9cm, minimum height=1cm] at (4,4) {Moment method flow};
