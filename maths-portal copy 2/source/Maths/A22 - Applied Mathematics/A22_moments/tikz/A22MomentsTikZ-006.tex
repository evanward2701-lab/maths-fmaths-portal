% Asset ID: A22MomentsTikZ-006
% Source: Rigid Bodies transcript section 4.
% Related lesson section: Worked Example 7; Worked Example 8.
% Purpose: Suspended beam with tensions.

\begin{tikzpicture}[scale=0.95, every node/.style={font=\sffamily}]
  \node[draw, rounded corners, fill=blue!8, align=center, minimum width=9cm, minimum height=1cm] at (4,4) {Suspended beam with tensions};
