% Asset ID: A22MomentsTikZ-009
% Source: MechYr2 Chapter 7 Applications of Forces, page 15.
% Related lesson section: Worked Example 11.
% Purpose: Rough rod with smooth peg.

\begin{tikzpicture}[scale=0.95, every node/.style={font=\sffamily}]
  \node[draw, rounded corners, fill=blue!8, align=center, minimum width=9cm, minimum height=1cm] at (4,4) {Rough rod with smooth peg};
