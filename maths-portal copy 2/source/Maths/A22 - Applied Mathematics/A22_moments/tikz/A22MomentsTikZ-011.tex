% Asset ID: A22MomentsTikZ-011
% Source: CCEA A22-MOM boundary mentioning hinged beams; Rigid Bodies transcript hinge sections.
% Related lesson section: Worked Example 13; Core Theory 8.
% Purpose: Hinged beam moment method.

\begin{tikzpicture}[scale=0.95, every node/.style={font=\sffamily}]
  \node[draw, rounded corners, fill=blue!8, align=center, minimum width=9cm, minimum height=1cm] at (4,4) {Hinged beam moment method};
