% Asset ID: A22MomentsTikZ-008
% Source: MechYr2 Chapter 4 Moments, pages 20 to 22; Rigid Bodies transcript section 8.
% Related lesson section: Worked Example 10; Common Mistakes and Exam Traps.
% Purpose: Point of tilting rule.

\begin{tikzpicture}[scale=0.95, every node/.style={font=\sffamily}]
  \node[draw, rounded corners, fill=blue!8, align=center, minimum width=9cm, minimum height=1cm] at (4,4) {Point of tilting rule};
