% Asset ID: A22MomentsTikZ-004
% Source: Rigid Bodies transcript sections 2 and 3.
% Related lesson section: Core Theory 4; Exam Technique Notes.
% Purpose: Choosing where to take moments.

\begin{tikzpicture}[scale=0.95, every node/.style={font=\sffamily}]
  \node[draw, rounded corners, fill=blue!8, align=center, minimum width=9cm, minimum height=1cm] at (4,4) {Choosing where to take moments};
