% Asset ID: A22MomentsTikZ-007
% Source: MechYr2 Chapter 4 Moments, page 17; Rigid Bodies transcript sections 6 and 7.
% Related lesson section: Worked Example 9; Key Definitions and Notation.
% Purpose: Non-uniform centre of mass.

\begin{tikzpicture}[scale=0.95, every node/.style={font=\sffamily}]
  \node[draw, rounded corners, fill=blue!8, align=center, minimum width=9cm, minimum height=1cm] at (4,4) {Non-uniform centre of mass};
